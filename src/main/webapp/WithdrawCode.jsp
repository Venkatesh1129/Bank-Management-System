...
<body>
	...
	try {
		...
		if(mybalance>withdrawamount){
			balance=mybalance-withdrawamount;
			...
			if(i>0) {
				...
				out.print("<p>your balance has decrease :"+ balance+"</p></div></body></html>");
				out.print("<a href=withdraw.jsp>Back</a>");
			}else {
				out.print("<h1>Login Failed</h1>");
				out.print("<a href=withdraw.jsp>Back</a>");
			}
		}else{
			out.print("<h1>Insufficient Fund</h1>");
			out.print("<a href=withdraw.jsp>Back</a>");
		}
		con.close();
	}catch(Exception ex) {
