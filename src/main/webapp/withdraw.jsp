...
<body>
	<h1>SDFC BANK</h1>
		...
		<h2 align=center>WITHDRAW FORM</h2>
		<form action="WithdrawCode.jsp" method="post" onsubmit="return withdraw_fun()" name="withdraw">
			...
			<tr>
				<td>Amount:</td>
				<td><input type="text" name="withdrawamount" placeholder="Enter amount"></td>
