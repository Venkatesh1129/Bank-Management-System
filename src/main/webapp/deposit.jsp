...
<body>
	<h1>SDFC BANK</h1>
		...
		<h2 align=center>DEPOSITE FORM</h2>
		<form action="DepositeCode.jsp" method="post" onsubmit="return deposit_fun()" name="deposit">
			...
			<tr>
				<td>Amount:</td>
				<td><input type="text" name="depositamount" placeholder="Enter amount"></td>
